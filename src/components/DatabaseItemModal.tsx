...
import { useUnits, useCreateMaterial, useCreateEquipment, useCreateLabor } from '../hooks/useDatabases';
...
const DatabaseItemModal: React.FC<DatabaseItemModalProps> = ({ 
  ...
  const { register, handleSubmit, formState: { errors }, reset } = useForm({
    defaultValues: getDefaultValues(resourceType)
  });
      ...
      <div className="bg-[#1a1a1a] rounded-lg p-6 w-full max-w-lg">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-white text-2xl font-semibold">
            Nuevo {resourceTitles[resourceType as keyof typeof resourceTitles]}
          </h2>
